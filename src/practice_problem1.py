...
class Box(object):
    ...
    def __init__(self, contents, volume):
        ...
        # --------------------------------------------------------------
        self.volume = volume
        self.ini_volume = volume
        self.history = []
        self.final_history = []
        if len(contents) <= volume:
            self.contents = contents
            self.ini_content = contents
        else:
            self.contents = ""
            self.ini_content = ""
    ...
    def append_string(self, additional_contents):
        ...
        if len(additional_contents) <= self.volume - len(self.contents):
            for k in range(len(additional_contents)):
                ...
                s = ''
        elif len(additional_contents) > self.volume - len(self.contents):
    ...
    def reset(self):
        ...
        self.contents = self.ini_content
        self.volume = self.ini_volume
    ...
    def combined_box(self, other_box):
        ...
        content = self.contents + other_box.contents
        return Box(content,volume)
