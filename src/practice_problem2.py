...
def run_test_practice_problem2a():
    ...
    print('answer:', practice_problem2a(test1, 6))
    print()
    test2 = [1, 1, 1]
    print('expected :', [3, 3, 3])
    print('answer:', practice_problem2a(test2, 2))
    print()
    test3 = [1, 2, 3]
    print('expected :', [3, 4, 5])
    print('answer:', practice_problem2a(test3, 2))
    print()
    test4 = [0, 0, 3]
    print('expected :', [2, 2, 5])
    print('answer:', practice_problem2a(test4, 2))
